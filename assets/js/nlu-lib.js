...
(function () {
  ...
  function probe(text) {
    ...
    if (/(你(在|现在)?(干嘛|干什么|干啥|做什么|忙什么)|在干嘛呢?|干啥呢|你最近在忙|近况|空又.{0,3}(在忙|状态))/.test(t) &&
        !/(你能|你会|能做|能做|能帮|有什么功能|有啥功能|能干)/.test(t)) {
    ...
    function tryHandwritten() {
      /* ---- ability questions (catch variants before the QA corpus) ---- */
      if (/(你能干啥|你能干点啥|你能做啥|你会干啥|你会做啥|能干啥|能做啥|能做什么|能干什么|能干嘛|你会什么|会什么|有什么功能|有啥功能|能帮我(做|干)?(什么|啥)|有什么能力|会点啥|能干点啥)/.test(t) &&
          !/(你在干啥|你干啥呢|干啥呢|在干什么|你在做什么|在干嘛)/.test(t)) {
        return P([
          "能干的多了喵：陪你聊天（2 万多条日常问答）、讲笑话、算数学、查元素/成语/国家、看天气和时间、玩游戏（猜数字/猜拳/故事接龙）、还能记住你的名字～ 配了本地模型还能变聪明！",
          "技能列表喵：1) 聊天解闷 2) 数学计算 3) 知识查询（元素/成语/国家/常数）4) 天气时间 5) 游戏三连（猜数字/猜拳/故事）6) 记名字和便签。说「玩个游戏」或「help」试试？",
        ]);
      }
      /* ---- Chinese extras ---- */
